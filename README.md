...
PROTOTIPO 1:
    ![IMG-prototipo-1-DATA LOVERS](https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox/FMfcgzGrbbzsDqqvltQlHpHlXrzTBqKg?projector=1&messagePartId=0.1)
PROTOTIPO 2 FINAL:
    ![IMG-prototipo-2-DATALOVERS](https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox/FMfcgzGrbbzsDrwVgDCWMxswBdwcXrJM?projector=1&messagePartId=0.1)
...
### 4. TESTEOS.
 ...
 Test. Los test de funcionaldad, pasaron correctamente al 100%.
   ![Captura.test100%](https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox/FMfcgzGrbbzsDqqBrSMnxdVPgKSpLXvd?projector=1&messagePartId=0.1)
 ...
 La organizacion del proyecto fue realizada en TRELLO, y se iba modificando a medida que se iba desarrollando este.
    ![Captura.IMG.TRELLO](https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox/FMfcgzGrbbzsDqqTLkXgXhrCdDqhLrXr?projector=1&messagePartId=0.1)

 ###6. INTERFAZ FINAL.
     A continuacón se muestra una imagen del producto final.(proyecto finalizado)
     ![Captura.IMG.interfazfinal](https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox/FMfcgzGrbbzsDrxHbRPrqrLwjnpVbKDr?projector=1&messagePartId=0.1)
